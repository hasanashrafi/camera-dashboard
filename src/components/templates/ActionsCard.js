...
function ActionsCard() {
  return (
    ...
    <button onClick={() => toast.success("Recording...")} className='w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2'>
